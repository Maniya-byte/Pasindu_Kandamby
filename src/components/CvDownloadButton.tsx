  ...
  return (
    <div className="relative inline-flex flex-col items-center">
      <motion.button
        ...
        className="relative inline-flex items-center gap-3 rounded-full bg-primary px-8 py-4 text-base font-semibold text-primary-foreground shadow-[var(--shadow-glow)] transition-shadow hover:shadow-[0_0_60px_-10px_hsl(36_90%_55%_/_0.5)] overflow-hidden"
      >
