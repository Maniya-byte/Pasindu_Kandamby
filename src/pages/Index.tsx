    ...
    <Layout>
      ...
      <section className="section-padding">
        <div className="mx-auto flex max-w-6xl flex-col items-center gap-10 md:flex-row md:gap-16">
          ...
          >
            <p className="font-mono text-sm tracking-widest text-primary uppercase mb-2">Hello, I'm</p>
            <h1 className="text-4xl font-bold leading-tight md:text-5xl lg:text-6xl text-balance">
              {profileData.name}
            </h1>
            <p className="mt-2 text-xl text-muted-foreground">{profileData.title}</p>
            <p className="mt-4 max-w-lg text-muted-foreground leading-relaxed">{profileData.bio}</p>
      ...
      <section className="section-padding bg-card/50">
        <div className="mx-auto max-w-6xl">
          ...
          >
            <p className="font-mono text-sm tracking-widest text-primary uppercase mb-2">What I Do</p>
            <h2 className="text-3xl font-bold md:text-4xl">Project Categories</h2>
          </motion.div>
      ...
      <section className="section-padding">
        <div className="mx-auto max-w-6xl">
          ...
          >
            <div>
              <p className="font-mono text-sm tracking-widest text-primary uppercase mb-2">Recent Work</p>
